$(function(){yii.confirm=function(t,n,i){var o=$(this);bootbox.confirm(t,function(t){if(t)if(o.data("ajax")){var a=$(o.data("target")),e=o.data("ajax");$.ajax({url:o.attr("href"),method:o.data("method")||"post",params:o.data("params"),success:function(){a.length&&("remove"===e?a.remove():"success"===e&&a.toggleClass("bg-success"))}})}else n&&n();else i&&i()})},$("[data-form-toggle]").change(function(){var s=$(this),l=s.find("option:selected");s.data("targets")&&$(s.data("targets")).each(function(){this.show()}),s.data("targets",[]),$.each(s.data("form-toggle"),function(t,a){var e,n,i,o=$.isArray(a[0])?a[0]:[a[0]],r=$.isArray(a[1])?a[1]:[a[1]];for(n=String(l.length?(e=String(o[0]).match(/^data-([\w-]+)/))?l.data(e[1]):s.val():s.prop("checked")?s.val():0),t=0;t<o.length;t++)if(String(o[t])===n){for(i=0;i<r.length;i++)s.data("targets").push($(r[i].match(/^[.#]/)?r[i]:".field-"+r[i]).hide());break}})}).filter(":visible").trigger("change"),$("[data-form-target]").change(function(){var t=$(this),a=t.find("option:selected").data("value"),e=t.data("form-target");$(e.match(/^[.#]/)?e:"#"+e).html(a)}).filter(":visible").trigger("change"),$.fn.signupForm=function(){return $(this).on("beforeValidate",function(){var a=$("#token");a.val()||($("#tz").val(jstz.determine().name()),$("#honeypot").val(""),$.get(a.data("url"),function(t){a.val(t)}))})},Skeleton.initContent()});var Skeleton={initContent:function(t){var a=$(t||"body");a.find('[data-toggle="tooltip"]').tooltip(),$.hasOwnProperty("timeago")&&a.find(".timeago").timeago(),this.hasJUI()&&a.find(".sortable").each(function(){var t=$(this);t.sortable({clientOptions:{handle:".sortable-handle",axis:"y"},helper:function(t,a){var e=a.children(),n=a.clone();return n.children().each(function(t){$(this).width(e.eq(t).outerWidth())}),n},update:function(){$.post(t.data("sort-url"),$(this).sortable("serialize"))}})})},replaceWithAjax:function(a,t){var e=this,n=$(a);t=$.extend({url:document.location.href},"string"==typeof t?{url:t}:t||{}),$.ajax(t).done(function(t){e.initContent(n.html($("<div>").html(t).find(a).html()))})},hasJUI:function(){return $.hasOwnProperty("ui")}};