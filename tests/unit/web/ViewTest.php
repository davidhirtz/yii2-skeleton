...
class ViewTest extends Unit
{
    ...
    public function testHrefLangLinkTags(): void
    {
        ...
        $expected = [
            'hreflang_en' => '<link href="http://localhost/test?language=en" rel="alternate" hreflang="en">',
            'hreflang_de' => '<link href="http://localhost/test?language=de" rel="alternate" hreflang="de">',
        ];
    ...
    public function testImageMetaTags(): void
    {
        ...
        static::assertEquals("<meta property=\"og:image\" content=\"http://localhost/images/test.jpg\">", $view->metaTags[0]);
        ...
        static::assertContains('<link href="http://localhost/images/test-2.jpg" rel="image_src">', $view->linkTags);
    }
    ...
    public function testCanonicalTag(): void
    {
        ...
        static::assertContains('<link href="http://localhost/test" rel="canonical">', $view->linkTags);
    }
