...
trait ActiveFormTrait
{
            ...
            foreach ($this->fields as $options) {
                if (!is_string($options) && is_callable($options)) {
                    ...
                    if ($options instanceof \yii\widgets\ActiveField) {
                        ...
                        if (in_array($options->attribute, $this->i18nAttributes, true)) {
                ...
                echo in_array($attribute, $this->i18nAttributes, true)
    ...
    protected function getAutogeneratedField(array $options = []): ActiveField|string
    {
        ...
        if (in_array($type, ['dropDownList', 'select'], true)) {
    ...
    {
        return $this->showUnsafeAttributes || in_array($attribute, $this->model->safeAttributes(), true);
    }
}
