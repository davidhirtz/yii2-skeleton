 ...
 */
return [
    '301 - Moved permanently' => '301 - Dauerhaft umgezogen',
    '302 - Temporary redirect' => '302 - Temporär umgezogen',
    ...
    'Additional Redirects' => 'Zusätzliche Weiterleitungen',
    'Admin' => 'Admin',
    ...
    'Are you sure you want to delete all selected items?' => 'Sind Sie sich sicher, dass Sie alle ausgewählten Einträge löschen wollen?',
    'Are you sure you want to delete this user?' => 'Sind Sie sich sicher, dass Sie diesen Benutzer löschen wollen?',
    ...
    'Create New Redirect' => 'Neue Weiterleitung erstellen',
    'Create New User' => 'Neuen Benutzer erstellen',
    'Create Password' => 'Passwort erstellen',
    'Create and update redirect rules' => 'Weiterleitungen erstellen und aktualisieren',
    ...
    'Delete Redirect' => 'Weiterleitung löschen',
    'Delete User' => 'Benutzer löschen',
    'Delete expired sessions' => 'Abgelaufene Sitzungen löschen',
    ...
    'Expired sessions: {count,number}' => 'Abgelaufene Sitzungen: {count,number}',
    'Filter' => 'Filter',
    'Filter ...' => 'Filter ...',
    'First name' => 'Vorname',
    'Google Authenticator' => 'Google Authenticator',
    'Heading {n}' => 'Überschrift {n}',
    ...
    'Password reset link' => 'Passwort-Link',
    ...
    'The permission was assigned.' => 'Die Benutzerrechte wurden erteilt.',
    'The permission was removed.' => 'Die Benutzerrechte wurden entzogen.',
    ...
    'This website is currently offline for a scheduled maintenance. Please try again in a few minutes.' => 'Die Webseite ist momentan für geplante Wartungsarbeiten offline. Bitte versuchen Sie es in einigen Minuten erneut.',
    'Time' => 'Zeitpunkt',
    'Timezone' => 'Zeitzone',
    'To activate two-factor authentication please scan the QR code below with your Google Authenticator app and enter the 6-digit code. After completing this setup you will need to use the Google Authenticator for every login for extra security.' => 'Um die Zwei-Faktor-Authentifikation für Ihren Account zu aktivieren, scannen Sie bitte den folgenden QR-Code mit Ihrer Google Authenticator App und geben sie den 6-stelligen Code ein. Danach benötigen Sie für jeden Login zusätzlich einen Google Authenticator Code für zusätzliche Sicherheit.',
    'Toggle' => 'Umschalten',
    'Toggle navigation' => 'Navigation umschalten',
    'Transfer' => 'Übertragen',
    'Transfer Ownership' => 'Webseitenbesitzer ändern',
    'Two-factor authentication is enabled. Please enter the 6-digit code provided by your Google Authenticator app below to disable it.' => 'Zwei-Faktor-Authentifikation ist aktiv. Schreiben Sie den 6-stelligen Code aus Ihrer Google Authenticator App in das Textfeld unten um sie zu deaktivieren.',
