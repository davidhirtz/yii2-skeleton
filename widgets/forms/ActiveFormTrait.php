...
trait ActiveFormTrait
{
                    ...
                    if ($this->showUnsafeAttributes || in_array($attribute, $safeAttributes)) {
                        ...
                        if (in_array($attribute, $this->model->i18nAttributes)) {
                            foreach ($this->languages as $language) {
                                echo $this->getAutogeneratedField($attribute, array_merge($fieldConfig, ['language' => $language]));
                            }
                        }
                    }
                }
    ...
    protected function getAutogeneratedField($attribute, $fieldConfig = [])
    {
        ...
        $language = ArrayHelper::remove($fieldConfig, 'language');
        ...
        if($language) {
            $attribute = Yii::$app->getI18n()->getAttributeName($attribute, $language);
        }
